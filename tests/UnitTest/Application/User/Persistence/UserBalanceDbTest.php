...
/**
 * User/Persistence/UserBalanceDb.class.php 测试文件
 * @author chloroplast
...
class UserBalanceDbTest extends GenericTestCase
{
    ...
    {
        $this->stub = new \User\Persistence\UserBalanceDb();
    }
    ...
    {
        $key = $this->getPrivateProperty('User\Persistence\UserBalanceDb', 'table');
