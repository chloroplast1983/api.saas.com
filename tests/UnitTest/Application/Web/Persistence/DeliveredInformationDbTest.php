...
/**
 * Web/Persistence/DeliveredInformationDb.class.php 测试文件
 * @author chloroplast
...
class DeliveredInformationDbTest extends GenericTestCase
{
    ...
    {
        $this->stub = new \Web\Persistence\DeliveredInformationDb();
    }
    ...
    {
        $key = $this->getPrivateProperty('Web\Persistence\DeliveredInformationDb', 'table');
