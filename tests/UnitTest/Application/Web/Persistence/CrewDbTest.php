...
/**
 * Web/Persistence/CrewDb.class.php 测试文件
 * @author chloroplast
 * @version 1.0.20160218
 */
class CrewDbTest extends GenericTestCase
{
    ...
    {
        $this->stub = new \Web\Persistence\CrewDb();
    }

    /**
     * 测试该文件是否正确的继承db类
     */
    public function testCrewDbCorrectInstanceExtendsCache()
    {
     ...
     */
    public function testCrewDbCorrectKey()
    {
        $key = $this->getPrivateProperty('Web\Persistence\CrewDb', 'table');
