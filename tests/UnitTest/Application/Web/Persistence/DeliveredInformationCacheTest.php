...
/**
 * Web/Persistence/DeliveredInformationCache.class.php 测试文件
 * @author chloroplast
...
class DeliveredInformationCacheTest extends GenericTestCase
{
    ...
    {
        $this->stub = new \Web\Persistence\DeliveredInformationCache();
    }
    ...
    {
        $key = $this->getPrivateProperty('Web\Persistence\DeliveredInformationCache', 'key');
