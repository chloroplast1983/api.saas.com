...
/**
 * Web/Persistence/ShopDb.class.php 测试文件
 * @author chloroplast
 * @version 1.0.20160218
 */
class ShopDbTest extends GenericTestCase
{
    ...
    {
        $this->stub = new \Web\Persistence\ShopDb();
    }

    /**
     * 测试该文件是否正确的继承db类
     */
    public function testShopDbCorrectInstanceExtendsCache()
    {
     ...
     */
    public function testShopDbCorrectKey()
    {
        $key = $this->getPrivateProperty('Web\Persistence\ShopDb', 'table');
