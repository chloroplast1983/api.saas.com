...
class Guest
{
    ...
    public function __construct(int $id = 0)
    {
        ...
        $this->sourceShop = new \Web\Model\Shop();
        ;
    }
    ...
    {
         //调用注册命令
        $command = Core::$_container->call(['Web\Command\Guest\GuestCommandFactory','createCommand'], ['type'=>'signUp','data'=>$this]);
    ...
    {
         //调用注册命令
        $command = Core::$_container->call(['Web\Command\Guest\GuestCommandFactory','createCommand'], ['type'=>'updatePassword','data'=>$this]);
        return $command->execute();
    }
}
