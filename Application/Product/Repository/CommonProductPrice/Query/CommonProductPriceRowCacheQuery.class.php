...
class CommonProductPriceRowCacheQuery extends RowCacheQuery
{

    /**
     * @var string $parimartKey 查询数据的键
     */
    private $primaryKey = 'commonProductPriceId';

    /**
     * @var Persistence\ProductPriceCommonCache $cacheLayer
     */
    private $cacheLayer;//缓存层

    /**
     * @var Persistence\ProductPriceCommonDb $dbLayer
     */
    private $dbLayer;//数据层

    public function __construct(Persistence\ProductPriceCommonCache $cacheLayer, Persistence\ProductPriceCommonDb $dbLayer)
    {
