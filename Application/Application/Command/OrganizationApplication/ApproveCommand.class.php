...
class ApproveCommand implements Pcommand
{
    ...
    {
        //拼接数据库数组
        $mysqlDataArray = array('status'=>APPLICATION_VERIFIED,
        ...
        $this->organizationApplicationService->getApplication()->setStatus(APPLICATION_VERIFIED);
